...
ps(isnan(ps)) = 0.8;
[eta,qE,qQ,fs,fo,fm,fo0,fm0,Kn]    = Fluorescencemodel(ps,Kp,Kf,Kd,model_choice);
Kpa         = ps./fs*Kf;
...
function [eta,qE,qQ,fs,fo,fm,fo0,fm0,Kn] = Fluorescencemodel(ps,Kp,Kf,Kd,model_choice)
po0         = Kp./(Kf+Kd+Kp);         % dark photochemistry fraction (Genty et al., 1989)
